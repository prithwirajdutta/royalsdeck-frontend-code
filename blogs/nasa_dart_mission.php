...
<div class="container" style="padding:20px;margin-top:40px;">
    ...
    <center><img src="https://solarsystem.nasa.gov/system/resources/detail_files/2437_dart_mission_graphic.jpg" style="width:100%;min-height:300px;"/><br><br>
  <h1 style="color:#5B2C6F;">DART Mission – Double Asteroid Redirection Test</h1></center>
   <br>
   
      <center><b style="font-size:25px;text-align:justify;">What is DART Mission all about ?</b></center><br>
      <br>
      <ul  style="font-size:25px;">
          <li>Target the binary asteroid Didymos system</li>
          <li>Impact Didymos-B and change its orbital period</li>
          <li>Measure the period change from Earth</li>
      </ul>
      <br><br>
      <p style="font-size:25px;text-align:justify;">
      The Double Asteroid Redirection Test (DART) mission is directed by NASA. DART is a planetary defense-driven test of technologies for preventing an impact of Earth by a hazardous asteroid.<br><br>
      ...
      The DART spacecraft launch window begins in late July 2021.  DART will launch aboard a SpaceX Falcon 9 rocket from Vandenberg Air Force Base, California.
       <br><br><b>Reference </b><br><a href="https://www.nasa.gov/planetarydefense/dart" target="_blank">https://www.nasa.gov/planetarydefense/dart</a><br><a href="https://www.youtube.com/watch?v=LoLH3ruxDsY&t=271s" target="_blank">https://www.youtube.com/watch?v=LoLH3ruxDsY&t=271s</a>
       <a href="https://en.wikipedia.org/wiki/Double_Asteroid_Redirection_Test" target="_blank">https://en.wikipedia.org/wiki/Double_Asteroid_Redirection_Test</a><br>
       </p>
</div>
<br>
<!--************Footer***************-->
