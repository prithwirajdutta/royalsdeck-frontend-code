...
<div class="container" style="padding:20px;margin-top:40px;">
   <img src="https://c1.sfdcstatic.com/content/dam/blogs/us/September2015/marc%20keynote%20header.jpg" style="width:100%;min-height:600px;"/><br><br>
   <center><h1 style="color:#5B2C6F;">Story of Salesforce</h1></center>
   <br>
   <p style="font-size:25px;text-align:justify;"> Salesforce began in a small apartment in Telegraph Hill in San Francisco. Marc Benioff decided to leave a lucrative sales career at Oracle in order to pursue a vision.<br><br>Marc Benioff wanted to get out of the routine job and wanted to pursue his dream. He left Oracle to start with a cloud based CRM software “Salesforce” which was first of its kind during the time when software was delivered only through local installation processes. Salesforce was the first software solution to be delivered over the browser through a multitenant cloud infrastructure.<br><br>Soon Salesforce came to notice as Benioff hired paid actors to display “Anti-software” movement. This gained attention but none thought that this would take upon giant software companies. There were challenges to be overcome in terms of data security over the browser, and Benioff had to build trust that their data would be safe with Salesforce.<br><br>Back then CRM softwares turned complicated because of heavy features provided by software companies like SAP and Oracle. On the other hand what Salesforce introduced was easy to use and anyone could just login and use the system, first 5 users for free.<br><br>This was a revolution in the software industry and this model of business “SAAS” – Software as a Service came into existence and grew fast and more and more businesses adopted this methodology to deliver services to their clients worldwide.<br><br>In 2003, Salesforce introduced its first annual Dreamforce conference, which eventually turned out to be one of the greatest software events.<br><br>Soon, Salesforce started acquiring softwares to grow their footprint in the software industry. Salesforce successfully completed its first acquisition by buying ExactTarget and renaming it as Marketing Cloud. Later, Salesforce bought giants like Tableau.<br><br>From 2005 to 2014, Salesforce transformed from being a Software as a Service to Platform as a Service. It introduced its first on the cloud programming language APEX. <br><br>Salesforce later introduced AppExchange which is a platform to allow developers to create and sell their applications built on top of Salesforce Platform.<br><br>On 2008, Salesforce officially launched Force.com, which was the worlds first platform-as-a-service delivered over the cloud.<br><br>Salesforce acquired Tableau, Radian6, Jigsaw, Exacttarget and many other software solutions inorder to expand its business globally.<br><br>Salesforce turned out to be the worlds number 1 CRM software solution delivered over the cloud and the company continues to improve and grow.<br><br><b>Reference </b><br><a href="https://www.j2interactive.com/blog/brief-history-salesforce/">https://www.j2interactive.com/blog/brief-history-salesforce/</a><br><a href="https://usefyi.com/salesforce-history/">https://usefyi.com/salesforce-history/</a></p>
</div>
<br>
<!--************Footer***************-->
