...
<script>
 ...
 <div class="container-fluid" style="padding:20px;margin-top:40px;">
      <div class="container" id="shadow" style="padding:30px 10px;">
        <div class="row">
          <div class="col-md-4"><center><h1 style="font-size:50px;color:#884EA0;line-height:150px;">Fun Apps</center></div>
          <div class="col-md-7">
            <center>
            <h5>Course Guidelines</h5><br>
            <p>Want to build your career as a Application developer. Then you have arrived at the right place. Here you will find a series of free resources to help you learn build realtime applications from scratch. </p></center>
          </div>
           ...
           <div class="col-md-4"><div class="card">
             ...
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/jdWcOe-W2Bk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br><br>
                ...
                <br><br></center>
                 ...
                 <div class="col-md-4"><div class="card">
              <div class="card-body" id="shadow">
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/Hk9r5vEVEZ4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br><br>
                <center>
                <h4>Pokedex #1</h4>
                <p>Learn to build a pokemon app.</p><br>
            ...
            <div class="col-md-4"><div class="card">
              <div class="card-body" id="shadow">
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/i6PMwsgpnyg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br><br>
                <center>
                <h4>Pokedex #2</h4>
                <p>Learn to build a pokemon app.</p><br>
            ...
            <div class="col-md-4"><div class="card">
              <div class="card-body" id="shadow">
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/IuWirXfAuWs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br><br>
                <center>
                <h4>Pokedex #3</h4>
                <p>Learn to build a pokemon app.</p><br>
