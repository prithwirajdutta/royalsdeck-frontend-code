...
<div class="container-fluid" style="padding:20px;margin-top:40px;">
      <div class="container" id="shadow" style="padding:30px 10px;">
        <div class="row">
          <div class="col-md-4"><center><h1 style="font-size:150px;color:#3498DB;"><i class="fab fa-php"></i></h1></center></div>
          <div class="col-md-7">
            <center>
            <h5>Course Guidelines</h5><br>
            <p>This course is designed to enhance your knowledge by helping you build a Hospital Management System using html,css,bootstrap,php and mysql from scratch. I am sure even if you are a complete beginner you will be able to cope up with this course.</p></center>
          </div>
        ...
        <div class="row">
          <div class="col-md-4"><div class="card">
              ...
              <iframe width="100%" height="200px" src="https://www.youtube.com/embed/-kDu4X1VFBo?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe><br><br>
                <center>
                <h4>Part 1</h4>
                <p>Creating Login System</p><br>
              ...
              <div class="card-body">
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/8WSwEO90avQ?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe><br><br>
                <center>
                <h4>Part 2</h4>
                <p>Insert Data into database.</p><br>
                ...
                <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
              <iframe width="100%" height="200px" src="https://www.youtube.com/embed/tW0EQiz5Q0Q?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe><br><br>
                <center>
                <h4>Part 3</h4>
                <p>Display from database.</p><br>
              <br><br></center>
              </div>
            </div><br>
          </div>
                <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
              <iframe width="100%" height="200px" src="https://www.youtube.com/embed/u6VVToFT4ws?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe><br><br>
                <center>
                <h4>Part 4</h4>
                <p>Create a Search System.</p><br>
                ...
                <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
              <iframe width="100%" height="200px" src="https://www.youtube.com/embed/MxW04sG2dQg?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe><br><br>
                <center>
                <h4>Part 5</h4>
                <p>Implementing sweetalert on page load.</p><br>
                ...
                <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/ZLDDjNZ8KkI?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe><br><br>
                <center>
                <h4>Part 6</h4>
                <p>Update data from database.</p><br>
                ...
                <br><br></center>
                       ...
                       <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
              <iframe width="100%" height="200px" src="https://www.youtube.com/embed/gwzoK1RIKP8?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe><br><br>
                <center>
                <h4>Part 7</h4>
                <p>Database and select tags.</p><br>
            ...
            <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
              <iframe width="100%" height="200px" src="https://www.youtube.com/embed/PVaKI8Cnzao?rel=0&amp;showinfo=0" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Part 8</h4>
                <p>Session start and destroy.</p><br>
