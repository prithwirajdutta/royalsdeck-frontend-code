...
<div class="container-fluid" style="padding:20px;margin-top:40px;">
      <div class="container" id="shadow" style="padding:30px 10px;">
        <div class="row">
          <div class="col-md-4"><center><h1 style="font-size:150px;color:#F1C40F;"><i class="fab fa-js-square"></i></h1></center></div>
          <div class="col-md-7">
            <center>
            <h5>Course Guidelines</h5><br>
            <p>This course is designed to enhance your knowledge by developing simple web applications using javascript and some of the most popular javascript libraries such as jquery.</p></center>
          </div>
        ...
        <div class="row">
           <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
           <iframe width="100%" height="200px" src="https://www.youtube.com/embed/jKfhgz6x-GE?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Data Visualisation</h4>
                <p>Using Chart.js</p><br>
          ...
          <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
            <iframe width="100%" height="200px" src="https://www.youtube.com/embed/uRFLx1IAEMk?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Progress Bar</h4>
                <p>Using Jquery</p><br>
          ...
          <div class="col-md-4"><div class="card">
              ...
              <iframe width="100%" height="200px" src="https://www.youtube.com/embed/6gzefP4LCUA?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Temperature Calculator</h4>
                <p>Using Javascript and Bootstrap</p><br>
                ...
                <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/MxW04sG2dQg?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Professional Alerts</h4>
                <p>Using Sweetalert.js</p><br>
               ...
               <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
            <iframe width="100%" height="200px" src="https://www.youtube.com/embed/5GzbLIhoWgU?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Simple Interest Calculator</h4>
                <p>Using Javascript</p><br>
            ...
            <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
           <iframe width="100%" height="200px" src="https://www.youtube.com/embed/2_NT53X9AmE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br><br>
                <center>
                <h4>Reddit Image Processing App</h4>
                <p>Using Javascript</p><br>
