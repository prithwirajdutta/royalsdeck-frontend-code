...
<div class="container-fluid" style="padding:20px;margin-top:40px;">
      <div class="container" id="shadow" style="padding:30px 10px;">
        <div class="row">
          <div class="col-md-4"><center><h1 style="font-size:150px;color:#F39C12;"><b><i class="fab fa-html5"></i></b></h1></center></div>
          <div class="col-md-7">
            <center>
            <h5>Course Guidelines</h5><br>
            <p>Want to build your career as a front end developer. Then this is the right place to begin. In this course you will get to learn not only html and css. I will share with you tips and tricks to build websites like a pro from scratch.</p></center>
          </div>
        ...
        <div class="row">
          <div class="col-md-4"><div class="card">
              ...
              <iframe width="100%" height="200px" src="https://www.youtube.com/embed/uGJEUgMQPNg?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Forms #1</h4>
                <p>Only Html and Css</p><br>
              ...
              <div class="card-body">
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/LIZo3tPkr5s?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Forms #2</h4>
                <p>Only Html and Css</p><br>
                ...
                <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
              <iframe width="100%" height="200px" src="https://www.youtube.com/embed/w0Rz2EhXD80?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Frames</h4>
                <p>Only Html and Css</p><br>
              <br><br></center>
                ...
                <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
              <iframe width="100%" height="200px" src="https://www.youtube.com/embed/JIQF7FKtLSc?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Tables</h4>
                <p>Only Html and Css</p><br>
