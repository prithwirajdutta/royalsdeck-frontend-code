 ...
 #phone{
  ...
  <body>
   <div id="phone" style="margin-top:50px;">
    ...
    <div class="container" style="position:absolute;top:50px;right:10px;width:1000px;">
        <a href="#" class="btn btn-outline-danger" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:20px;background-color:#CDDC39;color:white;border-color:#CDDC39;"/>Submit</a>
        <a href="#" class="btn btn-outline-danger" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:20px;background-color:#00BCD4;color:white;border-color:#00BCD4;"/>Submit</a>
        <a href="#" class="btn btn-outline-danger" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:20px;background-color:#7C4DFF;color:white;border-color:#7C4DFF;"/>Submit</a>
        
      </div><br><br><br><br><br><br><br><br>
        <div style="background-color:#273746;width:100%;padding:20px;border-radius:20px;max-width:1000px;position:absolute;top:350px;right:50px;">
             <pre>
