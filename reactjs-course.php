...
<br>
 <div class="container-fluid" style="padding:20px;margin-top:40px;">
      <div class="container" id="shadow" style="padding:30px 10px;">
        <div class="row">
          <div class="col-md-4"><center><h1 style="font-size:150px;color:#E91E63;"><i class="fab fa-react"></i></h1></center></div>
          <div class="col-md-7">
            <center>
            <h5>Course Guidelines</h5><br>
            <p>Want to build your career as a react developer. Then you have arrived at the right place. Here you will find a series of free resources to help you learn react from scratch and then go pro by building real time applications. </p></center>
          </div>
        ...
        <div class="row">
          <div class="col-md-4"><div class="card">
             ...
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/YscBwOnWTmA?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Installation</h4>
                <p>Installation and project structure</p><br>
              ...
              <div class="card-body">
            <iframe width="100%" height="200px" src="https://www.youtube.com/embed/BS7Xry2Cv6M?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Props and Components</h4>
                <p>Props and Components in details</p><br>
                ...
                <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/nz8eWmOohDE?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>States and Events</h4>
                <p>States and Events in details</p><br>
              <br><br></center>
              </div>
            </div><br>
          </div>
                <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
              <iframe width="100%" height="200px" src="https://www.youtube.com/embed/5yjBirNQrWc?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Todo App</h4>
                <p>Build todo app,learn about map function.</p><br>
